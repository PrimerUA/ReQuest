...
public class FileDialog {
	...
	private FileDialogLitener m_SimpleFileDialogListener = null;
	private ArrayAdapter<String> m_listAdapter = null;
	
	public interface FileDialogLitener 
	{
		public void onChosenDir(String chosenDir);
	}

	
	public FileDialog(Context context, String file_select_type, FileDialogLitener FileDialoglitener) {
		...
		m_SimpleFileDialogListener = FileDialoglitener;
